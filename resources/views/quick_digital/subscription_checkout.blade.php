        ...
        <section class="container max-width custom-padding my-5">
            <div class="row justify-content-center g-3">
                <div class="col-12 col-md-8">
                    <form action="{{ route('cart.paymentSubscription') }}" method="post">@csrf
                        <h4 class="p-2 bg-black text-white rounded">আপনি এই পর্যন্ত এসেছেন,তারমানে আপনি একজন একশন টেকার 💪
                        </h4>
                        {{-- <h4 class="py-2">সাবস্ক্রিপশন টি কিনতে করতে আপনার নাম, ফোন নম্বর এবং ইমেইল এড্রেস দিন</h4> --}}
                        <input type="hidden" name="cart_id" value="{{ $cartDetails->id }}">
                        <div style="border: 2px solid rgb(181, 181, 181)">
                            <h4 class="px-4 my-5">আপনার অর্ডার </h4>
                            <div class="px-4">`
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">সাবস্ক্রিপশন প্যাকেজ </th>
                                            <th scope="col" class="text-end">মূল্য </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="py-3">{{ $cartDetails->subscription_package }} </td>
                                ...
                                <p>আপনার ব্যক্তিগত ডেটা আপনার অর্ডার প্রক্রিয়া করতে, এই ওয়েবসাইট জুড়ে আপনার অভিজ্ঞতা
                                    সমর্থন
                                    করতে এবং আমাদের প্রাইভেসি পলিসিতে বর্ণিত অন্যান্য উদ্দেশ্যে ব্যবহার করা হবে।</p>
                                <button type="submit" class="btn btn-primary btn-lg w-100 mb-4">অর্ডার সম্পূর্ণ
                                    করুন</button>
                            </div>
                        </div>
                    </form>
                    <div class="mt-3">
                        <h4 class="p-2 bg-black text-white rounded">ম্যানুয়ালি ওর্ডার করতে হোয়াটসঅ্যাপ অথবা ফেসবুকে মেসেজ
                            দিন ⤵️
                        </h4>
