    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Students List</h3>
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{ url('admin/add-edit-user') }}">
                                    <button type="button" class="btn btn-secondary btn-min-width mr-1 mb-1">
                                        <i class="feather icon-edit"></i> Add Students
                                    </button>
                                </a>
                                @endif
                                    ...
                                    <div style="overflow-x: auto;">
                                        <table id="subadmins" class="table table-striped table-bordered custom-toolbar-elements">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $user->id }}</td>
                                                    <td style="background-image: url('{{ !empty($user->image) ? asset('admin/images/user_images/' . $user->image) : asset('admin/images/user_images/no_image.jpg') }}'); background-size: cover; background-position: center center; height: 40px;">
                                                    </td>
                                                    <td>{{ $user->name }}</td>
                                                    <td>{{ $user->address }}</td>
                                                    <td>{{ $user->city }}</td>
                                                    ...
                                                    <td>{{ date('F j, Y, g:i a', strtotime($user->created_at)) }}
                                                    </td>
                                                    <td>
