            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('quick-shopping-product.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit') }}" placeholder="kg, pcs">
                                                @error('unit')
                                                <div id="emailHelp" class="form-text text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="emailHelp" class="form-text text-danger">{{ $message }}</div>
                                                @enderror
                                                <img id="thumbnail_image_prviewImage" style="border: 1px solid #ddd; padding:5px; width:100px; margin-top:10px" src="" alt="">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @enderror
                                                <div class="prviewImage" style="display: flex;flex-wrap:wrap;gap:.5em"></div>
                                            </div>
