...
document.getElementById("passwordInput1").addEventListener("click", function () {
    const passwordInput = document.getElementById("passInput1");
...
// ____________________________ toggle password show for login acc
document.getElementById("passwordInput2").addEventListener("click", function () {
    const passwordInput = document.getElementById("passInput2");
    const isPasswordVisible = passwordInput.getAttribute("type") === "text";
...
// ____________________________ toggle password show for login acc
document.getElementById("passwordInput3").addEventListener("click", function () {
    const passwordInput = document.getElementById("passInput3");
    const isPasswordVisible = passwordInput.getAttribute("type") === "text";
